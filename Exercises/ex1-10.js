...
let message = `once said that,"A person who never made a mistake never tried anything new."`;
console.log(famous_person, message);
/*>>Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name.
 Make sure you use each character combination, "\t" and "\n", at least once.
 Print the name once, so the whitespace around the name is displayed.
 Then print the name after striping the white spaces.*/
let nameWithSpace = "\t Hassan\n\tAmjad";
...
//  Print that message.
var myFavrtno = 33;
const MessageFavrtNo = `My favorite number is ${myFavrtno}.`;
...
const favFriends = ["Hassan", "Khizer", "Huzaifa", "Usman"];
